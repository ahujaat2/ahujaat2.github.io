...
function startQuiz(){
	...
	quiz_cont = document.getElementsByClassName("container")[0];
...
function chooseAnswer(event) {
	...
	if (ans_val == correct_ans.text) {
		...
		correct_button = getCorrectAnswerButton(correct_ans.text);
...
function getCorrectAnswerButton(correct_ans){
